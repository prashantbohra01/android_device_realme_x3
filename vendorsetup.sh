...
git clone --depth=1 https://github.com/Patriot-06/android_kernel_realme_x3.git kernel/realme/x3
git clone --depth=1 https://gitlab.com/ElectroPerf/atom-x-clang.git prebuilts/clang/host/linux-x86/clang-15.0
